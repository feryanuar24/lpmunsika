                            ...
                            <table class="kt-table" data-kt-datatable-table="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="w-24" data-kt-datatable-column="email_verified_at">
                                            <span class="kt-table-col"><span class="kt-table-col-label">Status
                                                    Verifikasi</span><span class="kt-table-col-sort"></span></span>
                                        </th>
                                        <th scope="col" class="w-24" data-kt-datatable-column="role_names">
...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataUsers = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('users.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                    ...
                    columns: {
                        ...
                        email_verified_at: {
                            render: function(value) {
                                if (value === 'Terverifikasi') {
                                    return '<span class="kt-badge kt-badge-success">' + value +
                                        '</span>';
                                } else {
                                    return '<span class="kt-badge kt-badge-destructive">' + value +
                                        '</span>';
                                }
                            },
                        },
                        role_names: {
                            render: function(value) {
                                if (value.length > 0) {
                                    return value
                                        .map(role => '<span class="kt-badge kt-badge-primary">' +
                                            role +
                                            '</span>')
                                        .join(' ');
                                } else {
                                    return '<span class="kt-badge kt-badge-secondary">Tidak ada role</span>';
                                }
                            },
                        },
                        created_at: {
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="${value.delete}" method="POST" class="delete-user-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataUsers.init();
            if (instance) {
