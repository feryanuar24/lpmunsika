                    ...
                    <div id="kt_datatable_remote_source" class="kt-card-table" data-kt-datatable-page-size="5"
                        ...
                        <div class="kt-table-wrapper kt-scrollable">
                            <table class="kt-table" data-kt-datatable-table="true">
                                <thead>
                                    <tr>
                                        <th scope="col" class="w-30" data-kt-datatable-column="permission_name">
                                            <span class="kt-table-col"><span class="kt-table-col-label">Nama Pemission</span><span
                                                    class="kt-table-col-sort"></span></span>
                                        </th>
                                        <th scope="col" class="w-30" data-kt-datatable-column="role_name">
                                            <span class="kt-table-col"><span class="kt-table-col-label">Nama Role</span><span
                                                    class="kt-table-col-sort"></span></span>
                                        </th>
...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataPermissionRole = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('permission-role.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        <form action="${value.delete}" method="POST" class="delete-permission-role-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataPermissionRole.init();
            if (instance) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('submit', function(e) {
                if (e.target && e.target.matches('.delete-permission-role-form')) {
                    e.preventDefault();

                    Swal.fire({
                        title: 'Konfirmasi',
                        text: 'Apakah Anda yakin ingin menghapus permission role ini?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Memproses...',
                                text: 'Permission role sedang dihapus.',
