...
@section('content')
    <div class="kt-card">
        ...
        <div class="kt-card-content">
            <form id="reset-password-form" action="{{ route('password.store') }}" class="space-y-5" method="POST">
                @csrf
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="kt-input w-full"
                        value="{{ old('email', $data['email']) }}" placeholder="Masukkan alamat email" required>
                    @error('email')
                ...
                <button type="submit" class="kt-btn kt-btn-primary">Reset</button>
            </form>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script>
        document.getElementById('reset-password-form').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                    title: 'Konfirmasi',
                    text: 'Lanjutkan mereset kata sandi Anda?',
                    icon: 'question',
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: 'Memproses...',
                            text: 'Sedang mereset kata sandi Anda',
