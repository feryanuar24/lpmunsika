        ...
        <div class="kt-card-heading">
            <div class="kt-card-header">
                <h2 class="kt-card-title">
                    Halaman Konfirmasi Kata Sandi
                </h2>
            </div>
        </div>

        <div class="kt-card-content">
            <form id="confirm-password-form" action="{{ route('password.confirm') }}" class="space-y-5" method="POST">
                @csrf
...
@push('scripts')
    ...
    <script>
        ...
        document.getElementById('confirm-password-form').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                    title: 'Konfirmasi',
                    text: 'Apakah kata sandi sudah benar?',
                    icon: 'question',
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: 'Memproses...',
                            text: 'Sedang mengonfirmasi kata sandi',
