                    ...
                    <table class="kt-table" data-kt-datatable-table="true">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-20" data-kt-datatable-column="display_name">
                                    ...
                                    <td>
                                        <div class="flex justify-start gap-2">
                                            ...
                                            <form action="{{ route('permissions.destroy', $permission->id) }}"
                                                ...
                                                @csrf
                                                <button type="button"
                                                    data-kt-modal-toggle="#modal-delete-permission-{{ $permission->id }}"
                                                    class="kt-btn kt-btn-icon kt-btn-outline size-6">
                                                    <i class="ki-filled ki-trash"></i>
                                                </button>
                                                <div class="kt-modal z-40" data-kt-modal="true"
                                                    id="modal-delete-permission-{{ $permission->id }}">
                                                    <div
                                                        ...
                                                        <div class="kt-modal-header">
                                                            ...
                                                            <button type="button" class="kt-modal-close"
                                                                ...
                                                                data-kt-modal-dismiss="#modal-delete-permission-{{ $permission->id }}">
