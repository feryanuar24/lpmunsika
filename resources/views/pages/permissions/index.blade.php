                            ...
                            <table class="kt-table" data-kt-datatable-table="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="w-24" data-kt-datatable-column="display_name">
                                            <span class="kt-table-col"><span class="kt-table-col-label">Nama Tampilan</span><span
                                                    class="kt-table-col-sort"></span></span>
                                        </th>
...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataPermissions = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('permissions.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="${value.delete}" method="POST" class="delete-permission-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataPermissions.init();
            if (instance) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('submit', function(e) {
                if (e.target && e.target.matches('.delete-permission-form')) {
                    e.preventDefault();
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Memproses...',
                                text: 'Permission sedang dihapus.',
