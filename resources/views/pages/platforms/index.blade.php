            ...
            <div class="kt-card-table" data-kt-datatable="true" data-kt-datatable-page-size="5"
                ...
                <div class="kt-table-wrapper kt-scrollable">
                    <table class="kt-table" data-kt-datatable-table="true">
                        <thead>
                            <tr>
                                <th scope="col" class="w-24" data-kt-datatable-column="name">
                                ...
                                <th scope="col" class="w-24" data-kt-datatable-column="icon">
                                    ...
                                    <td>
                                        <div class="flex justify-start gap-2">
                                            ...
                                            <form action="{{ route('platforms.destroy', $platform->id) }}" method="POST">
                                                ...
                                                @csrf
                                                <button type="button"
                                                    data-kt-modal-toggle="#modal-delete-platform-{{ $platform->id }}"
                                                    class="kt-btn kt-btn-icon kt-btn-outline size-6">
                                                    <i class="ki-filled ki-trash"></i>
                                                </button>
                                                <div class="kt-modal z-40" data-kt-modal="true"
                                                    id="modal-delete-platform-{{ $platform->id }}">
                                                    <div
                                                        ...
                                                        <div class="kt-modal-header">
                                                            ...
                                                            <button type="button" class="kt-modal-close"
                                                                ...
                                                                data-kt-modal-dismiss="#modal-delete-platform-{{ $platform->id }}">
