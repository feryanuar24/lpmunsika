...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataPlatforms = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('platforms.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                    ...
                    columns: {
                        ...
                        icon: {
                            title: 'Ikon',
                            render: function(value) {
                                return `<i class="ki-filled ${value}"></i>`;
                            },
                        },
                        actions: {
                            title: 'Aksi',
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="${value.delete}" method="POST" class="delete-platform-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataPlatforms.init();
            if (instance) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('submit', function(e) {
                if (e.target && e.target.matches('.delete-platform-form')) {
                    e.preventDefault();

                    Swal.fire({
                        title: 'Konfirmasi',
                        text: 'Apakah Anda yakin ingin menghapus platform ini?',
                        icon: 'warning',
