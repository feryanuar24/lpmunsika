    ...
    <div class="kt-card mx-7.5">
        ...
        <div class="kt-card-content">
            <form action="{{ route('roles.store') }}" method="POST" class="space-y-5">
                ...
                <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-create-role">Buat</button>

                <div class="kt-modal z-40" data-kt-modal="true" id="modal-create-role">
                    <div
                        ...
                        <div class="kt-modal-header">
                            ...
                            <button type="button" class="kt-modal-close" aria-label="Close modal"
                                data-kt-modal-dismiss="#modal-create-role">
                        ...
                        <div class="kt-modal-footer">
                            ...
                            <div class="flex gap-4">
                                <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-create-role"
