            ...
            <div class="grid w-full space-y-5">
                <div class="kt-card">
                    <div class="kt-card-header min-h-16">
                        <form action="{{ route('embeds.index') }}" method="get">
                            ...
                            <table class="kt-table" data-kt-datatable-table="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="w-24" data-kt-datatable-column="platform_name">
...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataEmbeds = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('embeds.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="${value.delete}" method="POST" class="delete-embed-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataEmbeds.init();
            if (instance) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('submit', function(e) {
                if (e.target && e.target.matches('.delete-embed-form')) {
                    e.preventDefault();

                    Swal.fire({
                        title: 'Konfirmasi',
                        text: 'Apakah Anda yakin ingin menghapus penyematan ini?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Memproses...',
                                text: 'Penyematan sedang dihapus.',
