                                    ...
                                    <td>
                                        <div class="flex justify-start gap-2">
                                            ...
                                            <form action="{{ route('sliders.destroy', $slider->id) }}" method="POST">
                                                ...
                                                @csrf
                                                <button type="button"
                                                    data-kt-modal-toggle="#modal-delete-slider-{{ $slider->id }}"
                                                    class="kt-btn kt-btn-icon kt-btn-outline size-6">
                                                    <i class="ki-filled ki-trash"></i>
                                                </button>
                                                <div class="kt-modal z-40" data-kt-modal="true"
                                                    id="modal-delete-slider-{{ $slider->id }}">
                                                    <div
                                                        ...
                                                        <div class="kt-modal-header">
                                                            ...
                                                            <button type="button" class="kt-modal-close"
                                                                ...
                                                                data-kt-modal-dismiss="#modal-delete-slider-{{ $slider->id }}">
                                                        ...
                                                        <div class="kt-modal-body">
                                                            <div class="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                    <p class="font-medium">Anda menghapus slider
                                                                        ini.
                                                                    </p>
                                                                    <p class="text-sm text-muted">Pastikan data
                                                                        sudah
                                                                        dicadangkan sebelum
                                                                        melanjutkan.</p>
                                                                </div>
