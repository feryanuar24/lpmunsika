...
@push('scripts')
    <script>
        ...
        var KTDatatableRemoteDataSliders = (function() {
            ...
            var init = function() {
                ...
                var datatable = new KTDataTable(datatableEl, {
                    apiEndpoint: '{{ route('sliders.datatable') }}',
                    requestMethod: 'GET',
                    requestHeaders: {
                            ...
                            render: function(value) {
                                return `
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="${value.delete}" method="POST" class="delete-slider-form">
                                            @method('DELETE')
                                            @csrf
        ...
        function safeInitialize() {
            ...
            var instance = KTDatatableRemoteDataSliders.init();
            if (instance) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.addEventListener('submit', function(e) {
                if (e.target && e.target.matches('.delete-slider-form')) {
                    e.preventDefault();
