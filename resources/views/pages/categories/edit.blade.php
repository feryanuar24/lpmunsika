...
@section('content')
    <div class="kt-card mx-7.5">
        ...
        <div class="kt-card-content">
            <form action="{{ route('categories.update', $data['category']->id) }}" method="POST" class="space-y-5">
                @method('PATCH')
                ...
                <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-edit-category">Edit</button>
                    ...
                    <div
                        ...
                        <div class="kt-modal-footer">
                            ...
                            <div class="flex gap-4">
                                <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-edit-category"
